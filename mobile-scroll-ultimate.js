...
(function() {
  ...
  function optimizeStars() {
    ...
    // ULTRA-MINIMAL STARS ON MOBILE
    const starCount = isMobile() ? 5 : 30;
    ...
    for (let i = 0; i < starCount; i++) {
      ...
      // MINIMAL STAR STYLES FOR MAXIMUM PERFORMANCE
      star.style.cssText = `
        width: 1px;
        height: 1px;
        ...
        animation: mobileStarFade ${4 + Math.random() * 2}s ease-in-out infinite;
    ...
    console.log('✅ Star animation optimization applied');
  }
